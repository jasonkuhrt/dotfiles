...
brew "lnav"          # log file navigator (syntax-aware, searchable, SQL)
brew "multitail"     # tail multiple files in split view
...
# Development
brew "node"          # bootstrap only (pnpm manages LTS)
brew "pnpm"          # fast package manager + node version manager
