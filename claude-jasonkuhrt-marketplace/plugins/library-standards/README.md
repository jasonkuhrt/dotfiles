...
- **validate-namespace-module**: Validates `_.ts` files after edits
- **validate-barrel-module**: Validates `__.ts` files after edits

### Skills

- **creating-libraries**: Guides creation of new libraries with correct structure
- **auditing-libraries**: Audits existing libraries for convention violations
