...
1. __Setup temporary tsconfig__ (if path provided):
...
3. __Fix errors systematically__:
...
4. __Design decision protocol__:
...
__YOU MUST NOT CLAIM SUCCESS UNLESS:__
...
__COMMON FAILURE MODES TO AVOID:__
