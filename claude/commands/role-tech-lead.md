...
- **Interactive Q&A mode** (default): Use the `AskUserQuestion` tool to gather technical requirements through structured questions
...
1. **First, understand the requirements** - Ask 1-4 essential questions to clarify:
