---
name: beads:teacher-refresh
description: Verifies the beads:teacher skill is still accurate with current beads version. Use after beads updates or when setup instructions seem stale.
---

# Beads Teacher Refresh

Meta-check: is `beads:teacher` still accurate with current beads?
...
Update `beads:teacher` setup steps and commands to match current beads, then test the onboarding flow on a fresh project.
