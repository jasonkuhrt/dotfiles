---
name: cc:managing-plugins
description: Use when installing, uninstalling, enabling, disabling, or updating Claude Code plugins or marketplaces. Covers CLI commands, scoping rules, worktree behavior, and known bugs.
---
...
- **Marketplace internals** (caching, versioning, local dev): `cc_managing-marketplaces`
- **Plugin authoring**: `plugin-dev:*`
- **Permission configuration**: `cc_managing-permissions`
