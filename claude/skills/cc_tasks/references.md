...
Raw sources for the cc_tasks skill. Preserved for posterity and future review.

## Recommended Reading

* https://paddo.dev/blog/from-beads-to-tasks/ — Best take on the layering: CC tasks = session-level coordination, beads = project-level persistent memory. Covers no-repo-awareness gotcha, multi-session persistence, complementary usage patterns.

## Official Docs (minimal)
...
## Anthropic Announcement (primary source — most detailed official content)
...
NOTE: cross post of the X announcement.
...
* https://github.com/L1AD/claude-task-viewer — Third-party task viewer UI
* https://paddo.dev/blog/from-beads-to-tasks/ — Beads vs Tasks layering analysis (tasks = session-level, beads = project-level)
...
* [v2.1.20](https://github.com/anthropics/claude-code/releases/tag/v2.1.20) — Task deletion via TaskUpdate, dynamic task list sizing
