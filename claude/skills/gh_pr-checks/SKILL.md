---
name: gh:pr-checks
description: Use when PR CI checks are failing, GitHub Actions workflow errors, asked to "fix CI", "make checks pass", "debug the build", "why is CI red", or after pushing when checks need monitoring until green.
---
