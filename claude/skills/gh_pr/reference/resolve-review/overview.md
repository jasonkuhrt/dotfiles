...
5. Parse all remaining files via [scripts/files-to-items.sh](../../scripts/resolve-review-files-to-items.sh)
6. Execute all actions via [scripts/apply-items.sh](../../scripts/resolve-review-apply-items.sh)
7. Show summary
...
1. Fetch via [scripts/fetch-pr-items.sh](../../scripts/resolve-review-fetch-pr-items.sh)
2. Analyze each item and populate analysis section
3. Generate files via [scripts/items-to-files.sh](../../scripts/resolve-review-items-to-files.sh)
