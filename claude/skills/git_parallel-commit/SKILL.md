---
name: git:parallel-commit
description: Safe concurrent git commits from parallel agents. Use when multiple background agents need to commit independently to the same repo without staging area conflicts.
---
