---
name: linear_workspace-pull
description: Pull and cache Linear workspace settings (teams, states, users, labels). Use when other linear_* skills need validated workspace data instead of guessing. Run once to initialize cache, rerun to refresh.
---

# Linear Workspace Pull

Downloads workspace-specific data from Linear and caches it locally. Other `linear_*` skills use this cache for validation instead of guessing UUIDs or state names.
