...
For submitting to external Tally forms (like Ref's doc request form), manual submission is the only option. The skill should:
1. Display field values in copy-friendly format
2. Provide the form URL
3. Guide user to paste and submit manually
