...
>
> However, don't get too excited just yet. Users quickly pointed out this is a very minimal implementation. The biggest complaint is that tasks are stored locally and aren't shareable via Git, and they're still waiting for Anthropic to add better project and team collaboration features.
>
