...
description: >-
  ...
  Use this skill for "$dispatch-claude" or whenever you need to hand off one or more independent tasks
  ...
  "dispatch Claude", or when you've prepared prompts that should each
  run in their own Claude session. This is agent-invokeable only — the agent
  uses it to launch Claude work, not the user directly. Always prefer this over
