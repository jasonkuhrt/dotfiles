...
```bash
bun x @jasonkuhrt/shan skills on <targets> [--scope user]
```
...
```bash
bun x @jasonkuhrt/shan skills off <targets> [--scope user]
```
...
```bash
bun x @jasonkuhrt/shan skills move <axis> <direction> <targets> [--scope user]
```
