---
name: cli
description: Conventions for the bash CLIs in this dotfiles setup, all built on argc. Use when writing, editing, or debugging one of these CLIs, or when reading their annotations — @describe, @flag, @option, @cmd, @arg. Help text is authoritative; do not read source for usage.
---
