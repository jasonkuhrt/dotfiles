---
name: dev-browser
description: Driving the dev-browser CLI and its CDP daemon against real Chrome. Use whenever running dev-browser, chrome-debug connect, --connect scripts, or any tool built on them (td, odyssey parks/huts sweeps) — and when those hang silently, exit 1, or report usecomputer not found. Covers connection caching, the daemon wedge, the expected /json 404, named pages, and QuickJS sandbox limits.
---
