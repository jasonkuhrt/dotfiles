---
name: react-19-and-compiler
description: React 19 and React Compiler era facts. Use when writing or reviewing React components and the question involves React.memo, useMemo, useCallback, forwardRef, displayName, or whether manual memoization is still warranted. Anchored release dates — do NOT web-search to re-derive them.
---
