...
| # | Section               | Purpose                                                                                 |
| - | --------------------- | --------------------------------------------------------------------------------------- |
| 1 | __Title + One-liner__ | What is this, in one sentence. Must fail the "could describe a different project" test. |
| 2 | __Problem__           | What sucks without this. Concrete, not abstract.                                        |
| 3 | __Solution__          | How this solves it. Three paragraphs max. No undefined terms.                           |
| 4 | __Quickstart__        | Get running in <5 minutes. Copy-pasteable. Every step must succeed.                     |
| 5 | __Concepts__          | Mental model. Narrative prose, dependency-ordered. Not a concept-per-heading dump.      |
| 6 | __Usage__             | Common tasks solved with real, copy-pasteable examples.                                 |
| 7 | __API Overview__      | Brief surface area. Points to reference docs, not exhaustive inline.                    |
| 8 | __Glossary__          | Every domain term, alphabetical, one definition each.                                   |
...
__Title + One-liner__: Generate 5 candidates. Pick the one naming something unique to THIS project. Test: could this describe a different project? If yes, reject it. The one-liner must contain at least one term specific to THIS project's domain.
