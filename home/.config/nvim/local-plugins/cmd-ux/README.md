...
- `lua/cmd_ux/lib/learning_runtime.lua`: learning runtime state, lifecycle, clock, and flush/session orchestration
...
- `lua/cmd_ux/lib/learning.lua`: public composition over the extracted learning modules
