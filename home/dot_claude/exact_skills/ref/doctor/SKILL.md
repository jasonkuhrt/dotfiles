---
name: ref:doctor
description: Use when setting up Ref MCP server, managing API keys, troubleshooting Ref documentation lookup issues, dashboard operations (adding repos, uploading files), understanding pricing/credits, or deciding Ref vs alternatives.
---

# Ref Doctor

Setup, configuration, and troubleshooting for the Ref documentation MCP server.

> **To search docs:** Use `/ref <question>` to force a documentation lookup.
