# Fish completions for dj (argc-generated)
function _argc_dj_completer
    set -g _argc_completer_words
    _argc_dj_completer_parse_line

    argc --argc-compgen fish "" $_argc_completer_words
end

function _argc_dj_completer_parse_line
...
complete -x -k -c dj -a "(_argc_dj_completer)"
