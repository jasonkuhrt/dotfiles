...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ApproximateNeedCountSort}.
*
...
* | **Parent** | {@link $Schema.ApproximateNeedCountSort} |
* | **Path** | `ApproximateNeedCountSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.ApproximateNeedCountSort} |
* | **Path** | `ApproximateNeedCountSort.order` |
* | **Nullability** | Optional |
*/
