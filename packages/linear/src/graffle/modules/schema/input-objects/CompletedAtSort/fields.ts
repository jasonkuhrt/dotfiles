...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CompletedAtSort}.
*
...
* | **Parent** | {@link $Schema.CompletedAtSort} |
* | **Path** | `CompletedAtSort.nulls` |
* | **Default** | `"last"` |
