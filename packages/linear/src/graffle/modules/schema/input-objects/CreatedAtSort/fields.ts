...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CreatedAtSort}.
*
...
* | **Parent** | {@link $Schema.CreatedAtSort} |
* | **Path** | `CreatedAtSort.nulls` |
* | **Default** | `"last"` |
