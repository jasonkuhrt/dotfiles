...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomViewCreatedAtSort}.
*
...
* | **Parent** | {@link $Schema.CustomViewCreatedAtSort} |
* | **Path** | `CustomViewCreatedAtSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.CustomViewCreatedAtSort} |
* | **Path** | `CustomViewCreatedAtSort.order` |
* | **Nullability** | Optional |
*/
