...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomViewSharedSort}.
*
...
* | **Parent** | {@link $Schema.CustomViewSharedSort} |
* | **Path** | `CustomViewSharedSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.CustomViewSharedSort} |
* | **Path** | `CustomViewSharedSort.order` |
* | **Nullability** | Optional |
*/
