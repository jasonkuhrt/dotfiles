...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomViewUpdatedAtSort}.
*
...
* | **Parent** | {@link $Schema.CustomViewUpdatedAtSort} |
* | **Path** | `CustomViewUpdatedAtSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.CustomViewUpdatedAtSort} |
* | **Path** | `CustomViewUpdatedAtSort.order` |
* | **Nullability** | Optional |
*/
