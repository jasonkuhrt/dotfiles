...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomerCountSort}.
*
...
* | **Parent** | {@link $Schema.CustomerCountSort} |
* | **Path** | `CustomerCountSort.nulls` |
* | **Default** | `"last"` |
