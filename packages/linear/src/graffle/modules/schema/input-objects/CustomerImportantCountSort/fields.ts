...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomerImportantCountSort}.
*
...
* | **Parent** | {@link $Schema.CustomerImportantCountSort} |
* | **Path** | `CustomerImportantCountSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.CustomerImportantCountSort} |
* | **Path** | `CustomerImportantCountSort.order` |
* | **Nullability** | Optional |
*/
