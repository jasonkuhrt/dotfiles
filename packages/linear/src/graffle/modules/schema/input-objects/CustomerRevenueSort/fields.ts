...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomerRevenueSort}.
*
...
* | **Parent** | {@link $Schema.CustomerRevenueSort} |
* | **Path** | `CustomerRevenueSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.CustomerRevenueSort} |
* | **Path** | `CustomerRevenueSort.order` |
* | **Nullability** | Optional |
*/
