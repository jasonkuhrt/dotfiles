...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomerSort}.
*
...
* | **Parent** | {@link $Schema.CustomerSort} |
* | **Path** | `CustomerSort.nulls` |
* | **Default** | `"last"` |
