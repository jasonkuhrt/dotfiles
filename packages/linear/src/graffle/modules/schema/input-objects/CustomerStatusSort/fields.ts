...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomerStatusSort}.
*
...
* | **Parent** | {@link $Schema.CustomerStatusSort} |
* | **Path** | `CustomerStatusSort.nulls` |
* | **Default** | `"last"` |
