...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomerTierFilter}.
*
...
* | **Parent** | {@link $Schema.CustomerTierFilter} |
* | **Path** | `CustomerTierFilter.id` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.CustomerTierFilter} |
* | **Path** | `CustomerTierFilter.createdAt` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.CustomerTierFilter} |
* | **Path** | `CustomerTierFilter.updatedAt` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.CustomerTierFilter} |
* | **Path** | `CustomerTierFilter.displayName` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.CustomerTierFilter} |
* | **Path** | `CustomerTierFilter.description` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.CustomerTierFilter} |
* | **Path** | `CustomerTierFilter.position` |
* | **Nullability** | Optional |
*/
...
type: readonly ($Schema.CustomerTierFilter['type'])[] | null | undefined
}
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.CustomerTierFilter}.
*
