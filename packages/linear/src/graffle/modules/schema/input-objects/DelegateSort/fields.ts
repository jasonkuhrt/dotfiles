...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.DelegateSort}.
*
...
* | **Parent** | {@link $Schema.DelegateSort} |
* | **Path** | `DelegateSort.nulls` |
* | **Default** | `"last"` |
