...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.DueDateSort}.
*
...
* | **Parent** | {@link $Schema.DueDateSort} |
* | **Path** | `DueDateSort.nulls` |
* | **Default** | `"last"` |
