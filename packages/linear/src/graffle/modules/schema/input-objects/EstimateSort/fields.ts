...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.EstimateSort}.
*
...
* | **Parent** | {@link $Schema.EstimateSort} |
* | **Path** | `EstimateSort.nulls` |
* | **Default** | `"last"` |
