...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeCreatedAtSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeCreatedAtSort} |
* | **Path** | `InitiativeCreatedAtSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.InitiativeCreatedAtSort} |
* | **Path** | `InitiativeCreatedAtSort.order` |
* | **Nullability** | Optional |
*/
