...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeHealthSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeHealthSort} |
* | **Path** | `InitiativeHealthSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.InitiativeHealthSort} |
* | **Path** | `InitiativeHealthSort.order` |
* | **Nullability** | Optional |
*/
