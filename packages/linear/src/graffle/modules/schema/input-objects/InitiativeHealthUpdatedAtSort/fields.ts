...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeHealthUpdatedAtSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeHealthUpdatedAtSort} |
* | **Path** | `InitiativeHealthUpdatedAtSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.InitiativeHealthUpdatedAtSort} |
* | **Path** | `InitiativeHealthUpdatedAtSort.order` |
* | **Nullability** | Optional |
*/
