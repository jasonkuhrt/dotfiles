...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeManualSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeManualSort} |
* | **Path** | `InitiativeManualSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.InitiativeManualSort} |
* | **Path** | `InitiativeManualSort.order` |
* | **Nullability** | Optional |
*/
