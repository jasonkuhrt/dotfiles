...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeNameSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeNameSort} |
* | **Path** | `InitiativeNameSort.nulls` |
* | **Default** | `"last"` |
