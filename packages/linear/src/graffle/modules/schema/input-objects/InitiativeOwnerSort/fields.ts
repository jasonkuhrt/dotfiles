...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeOwnerSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeOwnerSort} |
* | **Path** | `InitiativeOwnerSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.InitiativeOwnerSort} |
* | **Path** | `InitiativeOwnerSort.order` |
* | **Nullability** | Optional |
*/
