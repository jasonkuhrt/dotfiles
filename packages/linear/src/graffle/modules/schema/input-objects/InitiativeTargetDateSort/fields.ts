...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeTargetDateSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeTargetDateSort} |
* | **Path** | `InitiativeTargetDateSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.InitiativeTargetDateSort} |
* | **Path** | `InitiativeTargetDateSort.order` |
* | **Nullability** | Optional |
*/
