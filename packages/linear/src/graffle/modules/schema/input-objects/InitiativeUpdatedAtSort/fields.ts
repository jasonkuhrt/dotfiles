...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.InitiativeUpdatedAtSort}.
*
...
* | **Parent** | {@link $Schema.InitiativeUpdatedAtSort} |
* | **Path** | `InitiativeUpdatedAtSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.InitiativeUpdatedAtSort} |
* | **Path** | `InitiativeUpdatedAtSort.order` |
* | **Nullability** | Optional |
*/
