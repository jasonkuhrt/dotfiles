...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.LabelSort}.
*
...
* | **Parent** | {@link $Schema.LabelSort} |
* | **Path** | `LabelSort.nulls` |
* | **Default** | `"last"` |
