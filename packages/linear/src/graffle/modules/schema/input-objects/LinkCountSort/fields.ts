...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.LinkCountSort}.
*
...
* | **Parent** | {@link $Schema.LinkCountSort} |
* | **Path** | `LinkCountSort.nulls` |
* | **Default** | `"last"` |
