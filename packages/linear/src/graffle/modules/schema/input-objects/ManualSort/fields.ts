...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ManualSort}.
*
...
* | **Parent** | {@link $Schema.ManualSort} |
* | **Path** | `ManualSort.nulls` |
* | **Default** | `"last"` |
