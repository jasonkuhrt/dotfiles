...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.MilestoneSort}.
*
...
* | **Parent** | {@link $Schema.MilestoneSort} |
* | **Path** | `MilestoneSort.nulls` |
* | **Default** | `"last"` |
