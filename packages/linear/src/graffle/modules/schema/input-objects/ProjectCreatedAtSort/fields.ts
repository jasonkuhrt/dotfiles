...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectCreatedAtSort}.
*
...
* | **Parent** | {@link $Schema.ProjectCreatedAtSort} |
* | **Path** | `ProjectCreatedAtSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.ProjectCreatedAtSort} |
* | **Path** | `ProjectCreatedAtSort.order` |
* | **Nullability** | Optional |
*/
