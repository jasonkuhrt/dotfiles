...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectHealthSort}.
*
...
* | **Parent** | {@link $Schema.ProjectHealthSort} |
* | **Path** | `ProjectHealthSort.nulls` |
* | **Default** | `"last"` |
