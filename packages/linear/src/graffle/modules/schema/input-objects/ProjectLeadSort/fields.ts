...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectLeadSort}.
*
...
* | **Parent** | {@link $Schema.ProjectLeadSort} |
* | **Path** | `ProjectLeadSort.nulls` |
* | **Default** | `"last"` |
