...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectManualSort}.
*
...
* | **Parent** | {@link $Schema.ProjectManualSort} |
* | **Path** | `ProjectManualSort.nulls` |
* | **Default** | `"last"` |
