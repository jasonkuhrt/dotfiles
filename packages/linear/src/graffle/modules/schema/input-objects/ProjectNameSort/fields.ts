...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectNameSort}.
*
...
* | **Parent** | {@link $Schema.ProjectNameSort} |
* | **Path** | `ProjectNameSort.nulls` |
* | **Default** | `"last"` |
