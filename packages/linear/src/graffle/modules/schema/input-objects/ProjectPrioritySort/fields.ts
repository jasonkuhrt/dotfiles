...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectPrioritySort}.
*
...
* | **Parent** | {@link $Schema.ProjectPrioritySort} |
* | **Path** | `ProjectPrioritySort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.ProjectPrioritySort} |
* | **Path** | `ProjectPrioritySort.order` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $Schema.ProjectPrioritySort} |
* | **Path** | `ProjectPrioritySort.noPriorityFirst` |
* | **Default** | `false` |
* | **Nullability** | Optional |
*/
