...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectStatusSort}.
*
...
* | **Parent** | {@link $Schema.ProjectStatusSort} |
* | **Path** | `ProjectStatusSort.nulls` |
* | **Default** | `"last"` |
