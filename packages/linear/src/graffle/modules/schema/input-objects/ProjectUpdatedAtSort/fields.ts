...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ProjectUpdatedAtSort}.
*
...
* | **Parent** | {@link $Schema.ProjectUpdatedAtSort} |
* | **Path** | `ProjectUpdatedAtSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.ProjectUpdatedAtSort} |
* | **Path** | `ProjectUpdatedAtSort.order` |
* | **Nullability** | Optional |
*/
