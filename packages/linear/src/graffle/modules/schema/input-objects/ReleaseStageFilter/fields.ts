...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ReleaseStageFilter}.
*
...
* | **Parent** | {@link $Schema.ReleaseStageFilter} |
* | **Path** | `ReleaseStageFilter.id` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.ReleaseStageFilter} |
* | **Path** | `ReleaseStageFilter.createdAt` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.ReleaseStageFilter} |
* | **Path** | `ReleaseStageFilter.updatedAt` |
* | **Nullability** | Optional |
*/
...
* | | |
* | - | - |
* | **Type** | {@link $Schema.ReleaseStageTypeComparator} |
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlinputobjecttype | InputObject ↗} |
* | **Parent** | {@link $Schema.ReleaseStageFilter} |
* | **Path** | `ReleaseStageFilter.type` |
* | **Nullability** | Optional |
*/
...
name: "type",
inlineType: [0, ],
namedType: $Schema.ReleaseStageTypeComparator,
type: $Schema.ReleaseStageTypeComparator['type'] | null | undefined
}
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ReleaseStageFilter}.
*
...
type: readonly ($Schema.ReleaseStageFilter['type'])[] | null | undefined
}
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.ReleaseStageFilter}.
*
