...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.RevenueSort}.
*
...
* | **Parent** | {@link $Schema.RevenueSort} |
* | **Path** | `RevenueSort.nulls` |
* | **Default** | `"last"` |
