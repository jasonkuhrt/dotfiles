...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.SlaStatusSort}.
*
...
* | **Parent** | {@link $Schema.SlaStatusSort} |
* | **Path** | `SlaStatusSort.nulls` |
* | **Default** | `"last"` |
