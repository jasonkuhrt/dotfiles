...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.StartDateSort}.
*
...
* | **Parent** | {@link $Schema.StartDateSort} |
* | **Path** | `StartDateSort.nulls` |
* | **Default** | `"last"` |
