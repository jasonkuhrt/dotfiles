...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.TimeInStatusSort}.
*
...
* | **Parent** | {@link $Schema.TimeInStatusSort} |
* | **Path** | `TimeInStatusSort.nulls` |
* | **Default** | `"last"` |
