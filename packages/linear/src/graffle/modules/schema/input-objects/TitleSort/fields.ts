...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.TitleSort}.
*
...
* | **Parent** | {@link $Schema.TitleSort} |
* | **Path** | `TitleSort.nulls` |
* | **Default** | `"last"` |
