...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.UpdatedAtSort}.
*
...
* | **Parent** | {@link $Schema.UpdatedAtSort} |
* | **Path** | `UpdatedAtSort.nulls` |
* | **Default** | `"last"` |
