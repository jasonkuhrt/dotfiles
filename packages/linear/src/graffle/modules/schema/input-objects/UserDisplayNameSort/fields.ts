...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.UserDisplayNameSort}.
*
...
* | **Parent** | {@link $Schema.UserDisplayNameSort} |
* | **Path** | `UserDisplayNameSort.nulls` |
* | **Default** | `"last"` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlenumtype | Enum ↗} |
* | **Parent** | {@link $Schema.UserDisplayNameSort} |
* | **Path** | `UserDisplayNameSort.order` |
* | **Nullability** | Optional |
*/
