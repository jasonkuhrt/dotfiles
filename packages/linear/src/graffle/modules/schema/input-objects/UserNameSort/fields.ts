...
/**
* GraphQL {@link https://graphql.org/learn/schema/#input-types | input field} ↗ on type {@link $Schema.UserNameSort}.
*
...
* | **Parent** | {@link $Schema.UserNameSort} |
* | **Path** | `UserNameSort.nulls` |
* | **Default** | `"last"` |
