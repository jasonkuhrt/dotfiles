...
export * as ZendeskSettingsInput from './fields.js'
...
url: $Fields.url,
botUserId: $Fields.botUserId,
canReadCustomers: $Fields.canReadCustomers,
supportsOAuthRefresh: $Fields.supportsOAuthRefresh
},
type: {
...
url: $Fields.url['type'],
botUserId?: $Fields.botUserId['type'],
canReadCustomers?: $Fields.canReadCustomers['type'],
supportsOAuthRefresh?: $Fields.supportsOAuthRefresh['type']
}
}