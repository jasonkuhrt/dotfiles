...
namedType: {
kind: "__typename",
value: "LabelNotificationSubscription"
}
}

/**
* GraphQL {@link https://graphql.org/learn/queries/#fields | output field} ↗ on type {@link $Schema.LabelNotificationSubscription}.
*
...
* | **Parent** | {@link $Schema.LabelNotificationSubscription} |
