...
namedType: {
kind: "__typename",
value: "ProjectNotificationSubscription"
}
}

/**
* GraphQL {@link https://graphql.org/learn/queries/#fields | output field} ↗ on type {@link $Schema.ProjectNotificationSubscription}.
*
...
* | **Parent** | {@link $Schema.ProjectNotificationSubscription} |
