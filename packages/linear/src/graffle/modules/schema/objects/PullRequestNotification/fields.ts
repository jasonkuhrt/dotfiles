...
namedType: {
kind: "__typename",
value: "PullRequestNotification"
}
}

/**
* GraphQL {@link https://graphql.org/learn/queries/#fields | output field} ↗ on type {@link $Schema.PullRequestNotification}.
*
...
* | **Parent** | {@link $Schema.PullRequestNotification} |
