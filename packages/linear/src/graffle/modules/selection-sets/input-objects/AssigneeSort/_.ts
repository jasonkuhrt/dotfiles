...
export type * as AssigneeSort from './fields.js'
...
*/
export interface AssigneeSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
