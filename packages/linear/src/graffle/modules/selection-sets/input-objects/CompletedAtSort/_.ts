...
export type * as CompletedAtSort from './fields.js'
...
*/
export interface CompletedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
