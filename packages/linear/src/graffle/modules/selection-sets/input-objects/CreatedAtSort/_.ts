...
export type * as CreatedAtSort from './fields.js'
...
*/
export interface CreatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
