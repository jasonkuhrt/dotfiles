...
export type * as CustomViewNameSort from './fields.js'
...
*/
export interface CustomViewNameSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
