...
export type * as CustomViewUpdatedAtSort from './fields.js'
...
*/
export interface CustomViewUpdatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
