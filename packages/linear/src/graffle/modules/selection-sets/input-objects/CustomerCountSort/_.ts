...
export type * as CustomerCountSort from './fields.js'
...
*/
export interface CustomerCountSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
