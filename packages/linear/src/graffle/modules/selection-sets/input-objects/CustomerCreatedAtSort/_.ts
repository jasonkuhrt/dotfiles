...
export type * as CustomerCreatedAtSort from './fields.js'
...
*/
export interface CustomerCreatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
