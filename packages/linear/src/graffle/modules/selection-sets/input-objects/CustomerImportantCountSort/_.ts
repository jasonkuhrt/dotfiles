...
export type * as CustomerImportantCountSort from './fields.js'
...
*/
export interface CustomerImportantCountSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
