...
export type * as CustomerRevenueSort from './fields.js'
...
*/
export interface CustomerRevenueSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
