...
export type * as CustomerStatusSort from './fields.js'
...
*/
export interface CustomerStatusSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
