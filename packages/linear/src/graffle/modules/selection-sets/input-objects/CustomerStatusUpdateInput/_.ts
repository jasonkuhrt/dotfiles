...
export type * as CustomerStatusUpdateInput from './fields.js'
...
*/
export interface CustomerStatusUpdateInput<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
