...
export type * as InitiativeCreatedAtSort from './fields.js'
...
*/
export interface InitiativeCreatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
