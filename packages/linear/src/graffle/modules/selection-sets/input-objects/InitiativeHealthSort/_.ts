...
export type * as InitiativeHealthSort from './fields.js'
...
*/
export interface InitiativeHealthSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
