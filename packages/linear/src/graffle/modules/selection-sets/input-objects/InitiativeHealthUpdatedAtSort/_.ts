...
export type * as InitiativeHealthUpdatedAtSort from './fields.js'
...
*/
export interface InitiativeHealthUpdatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
