...
export type * as InitiativeManualSort from './fields.js'
...
*/
export interface InitiativeManualSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
