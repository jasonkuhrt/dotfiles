...
export type * as InitiativeNameSort from './fields.js'
...
*/
export interface InitiativeNameSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
