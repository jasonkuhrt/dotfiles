...
export type * as InitiativeOwnerSort from './fields.js'
...
*/
export interface InitiativeOwnerSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
