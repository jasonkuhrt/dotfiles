...
export type * as InitiativeTargetDateSort from './fields.js'
...
*/
export interface InitiativeTargetDateSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
