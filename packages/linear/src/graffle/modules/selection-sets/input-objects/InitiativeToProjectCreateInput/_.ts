...
export type * as InitiativeToProjectCreateInput from './fields.js'
...
*/
export interface InitiativeToProjectCreateInput<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
