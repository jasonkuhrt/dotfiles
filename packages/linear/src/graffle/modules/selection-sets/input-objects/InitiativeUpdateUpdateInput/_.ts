...
export type * as InitiativeUpdateUpdateInput from './fields.js'
...
*/
export interface InitiativeUpdateUpdateInput<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
