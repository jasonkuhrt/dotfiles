...
export type * as InitiativeUpdatedAtSort from './fields.js'
...
*/
export interface InitiativeUpdatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
