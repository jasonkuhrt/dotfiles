...
export type * as LabelGroupSort from './fields.js'
...
*/
export interface LabelGroupSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
...
*/
labelGroupId: $Scalars.String$NonNull<_$Context>
}