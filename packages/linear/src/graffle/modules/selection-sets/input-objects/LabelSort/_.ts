...
export type * as LabelSort from './fields.js'
...
*/
export interface LabelSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
