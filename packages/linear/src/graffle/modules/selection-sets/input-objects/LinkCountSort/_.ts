...
export type * as LinkCountSort from './fields.js'
...
*/
export interface LinkCountSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
