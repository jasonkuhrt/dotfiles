...
export type * as MilestoneSort from './fields.js'
...
*/
export interface MilestoneSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
