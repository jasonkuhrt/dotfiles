...
export type * as OwnerSort from './fields.js'
...
*/
export interface OwnerSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
