...
export type * as PrioritySort from './fields.js'
...
*/
export interface PrioritySort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
