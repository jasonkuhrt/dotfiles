...
export type * as ProjectCreatedAtSort from './fields.js'
...
*/
export interface ProjectCreatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
