...
export type * as ProjectLeadSort from './fields.js'
...
*/
export interface ProjectLeadSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
