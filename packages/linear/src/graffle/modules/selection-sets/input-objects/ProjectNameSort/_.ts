...
export type * as ProjectNameSort from './fields.js'
...
*/
export interface ProjectNameSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
