...
export type * as ProjectStatusFilter from './fields.js'
...
*/
export interface ProjectStatusFilter<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
...
*/
projects?: GraphqlKit.Document.Object.Var.MaybeSchemaful<$Named.ProjectCollectionFilter<_$Context> | null | undefined>,
/**
* Compound filters, all of which need to be matched by the project status.
*/
and?: GraphqlKit.Document.Object.Var.MaybeSchemaful<Array<GraphqlKit.Document.Object.Var.MaybeSchemaful<$Named.ProjectStatusFilter<_$Context> | null | undefined>> | null | undefined>,
/**
* Compound filters, one of which needs to be matched by the project status.
*/
or?: GraphqlKit.Document.Object.Var.MaybeSchemaful<Array<GraphqlKit.Document.Object.Var.MaybeSchemaful<$Named.ProjectStatusFilter<_$Context> | null | undefined>> | null | undefined>
}