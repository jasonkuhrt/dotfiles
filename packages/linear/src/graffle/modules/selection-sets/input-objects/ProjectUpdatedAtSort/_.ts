...
export type * as ProjectUpdatedAtSort from './fields.js'
...
*/
export interface ProjectUpdatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
