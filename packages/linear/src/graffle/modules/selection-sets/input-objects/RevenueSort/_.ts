...
export type * as RevenueSort from './fields.js'
...
*/
export interface RevenueSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
