...
export type * as SizeSort from './fields.js'
...
*/
export interface SizeSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
