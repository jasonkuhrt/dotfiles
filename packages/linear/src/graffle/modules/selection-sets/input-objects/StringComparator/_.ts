...
export type * as StringComparator from './fields.js'
...
*/
export interface StringComparator<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
* Equals constraint.
*/
