...
export type * as TargetDateSort from './fields.js'
...
*/
export interface TargetDateSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
