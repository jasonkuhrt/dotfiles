...
export type * as TeamSort from './fields.js'
...
*/
export interface TeamSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
