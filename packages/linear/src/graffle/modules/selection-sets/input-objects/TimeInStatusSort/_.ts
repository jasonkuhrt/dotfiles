...
export type * as TimeInStatusSort from './fields.js'
...
*/
export interface TimeInStatusSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
