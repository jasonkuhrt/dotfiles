...
export type * as TitleSort from './fields.js'
...
*/
export interface TitleSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
