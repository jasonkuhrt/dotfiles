...
export type * as TriageResponsibilityUpdateInput from './fields.js'
...
*/
export interface TriageResponsibilityUpdateInput<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
* The action to take when an issue is added to triage.
*/
action?: $Scalars.String<_$Context>,
/**
