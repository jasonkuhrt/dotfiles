...
export type * as UpdatedAtSort from './fields.js'
...
*/
export interface UpdatedAtSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
