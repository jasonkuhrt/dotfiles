...
export type * as UserDisplayNameSort from './fields.js'
...
*/
export interface UserDisplayNameSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
