...
export type * as UserNameSort from './fields.js'
...
*/
export interface UserNameSort<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> {
/**
