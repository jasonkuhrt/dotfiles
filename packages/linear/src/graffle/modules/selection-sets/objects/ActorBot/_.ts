...
export type * as ActorBot from './__.js'
...
* | **Fields** | 6 |
*/
export interface ActorBot<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ActorBot} |
* | **Path** | `ActorBot.id` |
...
* | **Nullability** | Optional |
*/
userDisplayName?: $Fields.userDisplayName.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.userDisplayName<_$Context>> | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
/**
