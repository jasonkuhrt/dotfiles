...
export type * as AgentActivityElicitationContent from './__.js'
...
* | **Fields** | 2 |
*/
export interface AgentActivityElicitationContent<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$AgentActivityElicitationContent} |
