...
export type * as AgentActivityPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface AgentActivityPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$AgentActivityPayload} |
...
* | **Nullability** | Required |
*/
agentActivity?: $Fields.agentActivity.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.agentActivity<_$Context>>
/**
