...
export type * as AgentActivityResponseContent from './__.js'
...
* | **Fields** | 2 |
*/
export interface AgentActivityResponseContent<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$AgentActivityResponseContent} |
