...
export type * as AgentActivityThoughtContent from './__.js'
...
* | **Fields** | 2 |
*/
export interface AgentActivityThoughtContent<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$AgentActivityThoughtContent} |
