...
export type * as AgentSessionPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface AgentSessionPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$AgentSessionPayload} |
