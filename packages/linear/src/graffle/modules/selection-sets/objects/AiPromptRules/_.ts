...
export type * as AiPromptRules from './__.js'
...
*/
export interface AiPromptRules<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$AiPromptRules} |
* | **Path** | `AiPromptRules.id` |
