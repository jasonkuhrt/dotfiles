...
export type * as AuditEntryType from './__.js'
...
* | **Fields** | 2 |
*/
export interface AuditEntryType<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$AuditEntryType} |
* | **Path** | `AuditEntryType.type` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$AuditEntryType} |
* | **Path** | `AuditEntryType.description` |
* | **Nullability** | Required |
*/
