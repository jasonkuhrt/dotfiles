...
export type * as CommentPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface CommentPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CommentPayload} |
