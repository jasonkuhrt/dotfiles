...
export type * as CustomViewPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface CustomViewPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomViewPayload} |
