...
export type * as CustomerNeedConnection from './__.js'
...
* | **Fields** | 3 |
*/
export interface CustomerNeedConnection<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$CustomerNeedEdge}[]! |
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$CustomerNeedConnection} |
* | **Path** | `CustomerNeedConnection.edges` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$CustomerNeedConnection} |
* | **Path** | `CustomerNeedConnection.nodes` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$CustomerNeedConnection} |
* | **Path** | `CustomerNeedConnection.pageInfo` |
* | **Nullability** | Required |
*/
