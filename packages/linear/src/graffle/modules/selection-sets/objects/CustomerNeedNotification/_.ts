...
export type * as CustomerNeedNotification from './__.js'
...
*/
export interface CustomerNeedNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomerNeedNotification} |
...
* | **Nullability** | Optional |
*/
relatedIssue?: $Fields.relatedIssue.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.relatedIssue<_$Context>>
/**
