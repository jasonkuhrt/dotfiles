...
export type * as CustomerNeedPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface CustomerNeedPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomerNeedPayload} |
