...
export type * as CustomerNotificationSubscription from './__.js'
...
*/
export interface CustomerNotificationSubscription<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomerNotificationSubscription} |
