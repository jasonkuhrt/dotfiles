...
export type * as CustomerPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface CustomerPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomerPayload} |
