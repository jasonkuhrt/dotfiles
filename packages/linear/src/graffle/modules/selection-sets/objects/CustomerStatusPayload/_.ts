...
export type * as CustomerStatusPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface CustomerStatusPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomerStatusPayload} |
