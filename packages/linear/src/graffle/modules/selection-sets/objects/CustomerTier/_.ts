...
export type * as CustomerTier from './__.js'
...
*/
export interface CustomerTier<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomerTier} |
