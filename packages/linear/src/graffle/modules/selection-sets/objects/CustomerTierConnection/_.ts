...
export type * as CustomerTierConnection from './__.js'
...
* | **Fields** | 3 |
*/
export interface CustomerTierConnection<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$CustomerTierEdge}[]! |
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$CustomerTierConnection} |
* | **Path** | `CustomerTierConnection.edges` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$CustomerTierConnection} |
* | **Path** | `CustomerTierConnection.nodes` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$CustomerTierConnection} |
* | **Path** | `CustomerTierConnection.pageInfo` |
* | **Nullability** | Required |
*/
