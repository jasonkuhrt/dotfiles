...
export type * as CustomerTierPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface CustomerTierPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CustomerTierPayload} |
...
* | **Nullability** | Required |
*/
tier?: $Fields.tier.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.tier<_$Context>>
/**
