...
export type * as CycleNotificationSubscription from './__.js'
...
*/
export interface CycleNotificationSubscription<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CycleNotificationSubscription} |
