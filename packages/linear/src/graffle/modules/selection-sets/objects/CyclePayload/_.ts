...
export type * as CyclePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface CyclePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CyclePayload} |
