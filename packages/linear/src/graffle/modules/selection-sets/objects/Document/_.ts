...
export type * as Document from './__.js'
...
*/
export interface Document<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$Document} |
* | **Path** | `Document.id` |
