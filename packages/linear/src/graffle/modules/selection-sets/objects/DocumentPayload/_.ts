...
export type * as DocumentPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface DocumentPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$DocumentPayload} |
