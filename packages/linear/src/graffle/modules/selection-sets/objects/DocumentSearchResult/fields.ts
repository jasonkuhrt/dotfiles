...
export type updatedBy<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = updatedBy.$SelectionSet<_$Context>
...
export type hiddenAt<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
| hiddenAt.$SelectionSet<_$Context>

export namespace hiddenAt {
export interface $SelectionSet<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.Base {
}

/**
* This is the "expanded" version of the `hiddenAt` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
...
* | **Parent** | {@link $NamedTypes.$DocumentSearchResult}.comments |
* | **Path** | `DocumentSearchResult.comments(filter)` |
...
* | **GraphQL Type** | `String` |
* | **Parent** | {@link $NamedTypes.$DocumentSearchResult}.comments |
* | **Path** | `DocumentSearchResult.comments(before)` |
* | **Nullability** | Optional |
*/
...
* | **GraphQL Type** | `String` |
* | **Parent** | {@link $NamedTypes.$DocumentSearchResult}.comments |
* | **Path** | `DocumentSearchResult.comments(after)` |
* | **Nullability** | Optional |
*/
...
* | **GraphQL Type** | `Int` |
* | **Parent** | {@link $NamedTypes.$DocumentSearchResult}.comments |
* | **Path** | `DocumentSearchResult.comments(first)` |
* | **Nullability** | Optional |
*/
...
* | **GraphQL Type** | `Int` |
* | **Parent** | {@link $NamedTypes.$DocumentSearchResult}.comments |
* | **Path** | `DocumentSearchResult.comments(last)` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$DocumentSearchResult}.comments |
* | **Path** | `DocumentSearchResult.comments(includeArchived)` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$DocumentSearchResult}.comments |
* | **Path** | `DocumentSearchResult.comments(orderBy)` |
* | **Nullability** | Optional |
*/
...
export type documentContentId<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
| documentContentId.$SelectionSet<_$Context>

export namespace documentContentId {
export interface $SelectionSet<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.Base {
}

/**
* This is the "expanded" version of the `documentContentId` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
...
export type metadata<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
| metadata.$SelectionSet<_$Context>
