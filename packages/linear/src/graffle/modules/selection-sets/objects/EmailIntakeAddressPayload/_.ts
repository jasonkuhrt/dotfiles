...
export type * as EmailIntakeAddressPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface EmailIntakeAddressPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$EmailIntakeAddressPayload} |
...
* | **Nullability** | Required |
*/
emailIntakeAddress?: $Fields.emailIntakeAddress.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.emailIntakeAddress<_$Context>>
/**
