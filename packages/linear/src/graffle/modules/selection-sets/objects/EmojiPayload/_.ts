...
export type * as EmojiPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface EmojiPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$EmojiPayload} |
...
* | **Nullability** | Required |
*/
emoji?: $Fields.emoji.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.emoji<_$Context>>
/**
