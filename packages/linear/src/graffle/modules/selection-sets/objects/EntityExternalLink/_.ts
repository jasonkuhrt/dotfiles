...
export type * as EntityExternalLink from './__.js'
...
*/
export interface EntityExternalLink<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$EntityExternalLink} |
* | **Path** | `EntityExternalLink.id` |
...
* | **Parent** | {@link $NamedTypes.$EntityExternalLink} |
* | **Path** | `EntityExternalLink.createdAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$EntityExternalLink} |
* | **Path** | `EntityExternalLink.updatedAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$EntityExternalLink} |
* | **Path** | `EntityExternalLink.archivedAt` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$EntityExternalLink} |
* | **Path** | `EntityExternalLink.sortOrder` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$EntityExternalLink} |
* | **Path** | `EntityExternalLink.creator` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$EntityExternalLink} |
* | **Path** | `EntityExternalLink.initiative` |
* | **Nullability** | Optional |
*/
