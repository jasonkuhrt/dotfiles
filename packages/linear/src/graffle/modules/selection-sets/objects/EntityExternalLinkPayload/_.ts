...
export type * as EntityExternalLinkPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface EntityExternalLinkPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$EntityExternalLinkPayload} |
...
* | **Nullability** | Required |
*/
entityExternalLink?: $Fields.entityExternalLink.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.entityExternalLink<_$Context>>
/**
