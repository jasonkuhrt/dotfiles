...
export type * as ExternalEntityInfo from './__.js'
...
* | **Fields** | 3 |
*/
export interface ExternalEntityInfo<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ExternalEntityInfo} |
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$ExternalSyncService}! |
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$ExternalEntityInfoMetadata} |
