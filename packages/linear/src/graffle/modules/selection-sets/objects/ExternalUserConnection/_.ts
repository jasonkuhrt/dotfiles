...
export type * as ExternalUserConnection from './__.js'
...
* | **Fields** | 3 |
*/
export interface ExternalUserConnection<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$ExternalUserEdge}[]! |
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$ExternalUserConnection} |
* | **Path** | `ExternalUserConnection.edges` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$ExternalUserConnection} |
* | **Path** | `ExternalUserConnection.nodes` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$ExternalUserConnection} |
* | **Path** | `ExternalUserConnection.pageInfo` |
* | **Nullability** | Required |
*/
