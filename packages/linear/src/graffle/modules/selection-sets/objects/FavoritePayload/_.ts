...
export type * as FavoritePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface FavoritePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$FavoritePayload} |
