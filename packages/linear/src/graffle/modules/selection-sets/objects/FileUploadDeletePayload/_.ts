...
export type * as FileUploadDeletePayload from './__.js'
...
* | **Fields** | 1 |
*/
export interface FileUploadDeletePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$FileUploadDeletePayload} |
