...
export type * as FrontAttachmentPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface FrontAttachmentPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$FrontAttachmentPayload} |
* | **Path** | `FrontAttachmentPayload.lastSyncId` |
...
* | **Parent** | {@link $NamedTypes.$FrontAttachmentPayload} |
* | **Path** | `FrontAttachmentPayload.attachment` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$FrontAttachmentPayload} |
* | **Path** | `FrontAttachmentPayload.success` |
* | **Nullability** | Required |
*/
