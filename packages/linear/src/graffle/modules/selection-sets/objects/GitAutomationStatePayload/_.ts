...
export type * as GitAutomationStatePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface GitAutomationStatePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$GitAutomationStatePayload} |
...
* | **Nullability** | Required |
*/
gitAutomationState?: $Fields.gitAutomationState.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.gitAutomationState<_$Context>>
/**
