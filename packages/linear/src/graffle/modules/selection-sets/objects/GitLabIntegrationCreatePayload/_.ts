...
export type * as GitLabIntegrationCreatePayload from './__.js'
...
* | **Fields** | 4 |
*/
export interface GitLabIntegrationCreatePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$GitLabIntegrationCreatePayload} |
