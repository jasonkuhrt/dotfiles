...
export type * as ImageUploadFromUrlPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ImageUploadFromUrlPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ImageUploadFromUrlPayload} |
* | **Path** | `ImageUploadFromUrlPayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ImageUploadFromUrlPayload} |
* | **Path** | `ImageUploadFromUrlPayload.url` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ImageUploadFromUrlPayload} |
* | **Path** | `ImageUploadFromUrlPayload.success` |
* | **Nullability** | Required |
*/
