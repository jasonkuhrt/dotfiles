...
export type * as InitiativeArchivePayload from './__.js'
...
*/
export interface InitiativeArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativeArchivePayload} |
* | **Path** | `InitiativeArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeArchivePayload} |
* | **Path** | `InitiativeArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$InitiativeArchivePayload} |
* | **Path** | `InitiativeArchivePayload.entity` |
