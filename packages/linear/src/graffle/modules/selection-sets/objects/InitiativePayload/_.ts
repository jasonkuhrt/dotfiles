...
export type * as InitiativePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface InitiativePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativePayload} |
