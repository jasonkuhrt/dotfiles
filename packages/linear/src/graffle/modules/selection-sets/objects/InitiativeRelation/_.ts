...
export type * as InitiativeRelation from './__.js'
...
*/
export interface InitiativeRelation<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativeRelation} |
* | **Path** | `InitiativeRelation.id` |
...
* | **Parent** | {@link $NamedTypes.$InitiativeRelation} |
* | **Path** | `InitiativeRelation.createdAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeRelation} |
* | **Path** | `InitiativeRelation.updatedAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeRelation} |
* | **Path** | `InitiativeRelation.archivedAt` |
...
* | **Parent** | {@link $NamedTypes.$InitiativeRelation} |
* | **Path** | `InitiativeRelation.initiative` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeRelation} |
* | **Path** | `InitiativeRelation.relatedInitiative` |
* | **Nullability** | Required |
*/
relatedInitiative?: $Fields.relatedInitiative.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.relatedInitiative<_$Context>>
/**
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeRelation} |
* | **Path** | `InitiativeRelation.sortOrder` |
* | **Nullability** | Required |
*/
