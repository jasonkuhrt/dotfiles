...
export type * as InitiativeRelationPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface InitiativeRelationPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativeRelationPayload} |
...
* | **Nullability** | Required |
*/
initiativeRelation?: $Fields.initiativeRelation.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.initiativeRelation<_$Context>>
/**
