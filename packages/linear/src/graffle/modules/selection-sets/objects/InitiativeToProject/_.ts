...
export type * as InitiativeToProject from './__.js'
...
*/
export interface InitiativeToProject<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativeToProject} |
* | **Path** | `InitiativeToProject.id` |
...
* | **Parent** | {@link $NamedTypes.$InitiativeToProject} |
* | **Path** | `InitiativeToProject.createdAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeToProject} |
* | **Path** | `InitiativeToProject.updatedAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeToProject} |
* | **Path** | `InitiativeToProject.archivedAt` |
...
* | **Parent** | {@link $NamedTypes.$InitiativeToProject} |
* | **Path** | `InitiativeToProject.project` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeToProject} |
* | **Path** | `InitiativeToProject.initiative` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeToProject} |
* | **Path** | `InitiativeToProject.sortOrder` |
* | **Nullability** | Required |
*/
