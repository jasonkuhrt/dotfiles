...
export type * as InitiativeToProjectPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface InitiativeToProjectPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativeToProjectPayload} |
...
* | **Nullability** | Required |
*/
initiativeToProject?: $Fields.initiativeToProject.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.initiativeToProject<_$Context>>
/**
