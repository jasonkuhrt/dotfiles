...
export type * as InitiativeUpdateArchivePayload from './__.js'
...
*/
export interface InitiativeUpdateArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativeUpdateArchivePayload} |
