...
export type * as InitiativeUpdateReminderPayload from './__.js'
...
* | **Fields** | 2 |
*/
export interface InitiativeUpdateReminderPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$InitiativeUpdateReminderPayload} |
* | **Path** | `InitiativeUpdateReminderPayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$InitiativeUpdateReminderPayload} |
* | **Path** | `InitiativeUpdateReminderPayload.success` |
* | **Nullability** | Required |
*/
