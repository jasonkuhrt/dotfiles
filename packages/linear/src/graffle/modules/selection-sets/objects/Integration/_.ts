...
export type * as Integration from './__.js'
...
*/
export interface Integration<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$Integration} |
* | **Path** | `Integration.id` |
