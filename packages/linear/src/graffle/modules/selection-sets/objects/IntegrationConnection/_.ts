...
export type * as IntegrationConnection from './__.js'
...
* | **Fields** | 3 |
*/
export interface IntegrationConnection<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$IntegrationEdge}[]! |
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$IntegrationConnection} |
* | **Path** | `IntegrationConnection.edges` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$IntegrationConnection} |
* | **Path** | `IntegrationConnection.nodes` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$IntegrationConnection} |
* | **Path** | `IntegrationConnection.pageInfo` |
* | **Nullability** | Required |
*/
