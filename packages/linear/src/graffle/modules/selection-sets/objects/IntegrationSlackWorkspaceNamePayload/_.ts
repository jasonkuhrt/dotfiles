...
export type * as IntegrationSlackWorkspaceNamePayload from './__.js'
...
* | **Fields** | 2 |
*/
export interface IntegrationSlackWorkspaceNamePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IntegrationSlackWorkspaceNamePayload} |
