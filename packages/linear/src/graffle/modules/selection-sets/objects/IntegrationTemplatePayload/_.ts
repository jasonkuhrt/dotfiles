...
export type * as IntegrationTemplatePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IntegrationTemplatePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IntegrationTemplatePayload} |
...
* | **Nullability** | Required |
*/
integrationTemplate?: $Fields.integrationTemplate.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.integrationTemplate<_$Context>>
/**
