...
export type * as IntegrationsSettingsPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IntegrationsSettingsPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IntegrationsSettingsPayload} |
