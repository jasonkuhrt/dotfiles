...
export type * as IssueArchivePayload from './__.js'
...
*/
export interface IssueArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueArchivePayload} |
* | **Path** | `IssueArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$IssueArchivePayload} |
* | **Path** | `IssueArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$IssueArchivePayload} |
* | **Path** | `IssueArchivePayload.entity` |
