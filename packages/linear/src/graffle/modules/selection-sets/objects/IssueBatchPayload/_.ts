...
export type * as IssueBatchPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IssueBatchPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueBatchPayload} |
