...
export type * as IssueImportDeletePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IssueImportDeletePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueImportDeletePayload} |
