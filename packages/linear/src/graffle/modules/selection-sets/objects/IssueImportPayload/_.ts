...
export type * as IssueImportPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IssueImportPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueImportPayload} |
