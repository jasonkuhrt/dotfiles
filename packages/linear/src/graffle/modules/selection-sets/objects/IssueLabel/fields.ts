...
export type isGroup<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
| isGroup.$SelectionSet<_$Context>

export namespace isGroup {
export interface $SelectionSet<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.Base {
}

/**
* This is the "expanded" version of the `isGroup` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
...
export type lastAppliedAt<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
| lastAppliedAt.$SelectionSet<_$Context>

export namespace lastAppliedAt {
export interface $SelectionSet<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.Base {
}

/**
* This is the "expanded" version of the `lastAppliedAt` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
...
export type retiredAt<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
| retiredAt.$SelectionSet<_$Context>

export namespace retiredAt {
export interface $SelectionSet<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.Base {
}

/**
* This is the "expanded" version of the `retiredAt` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
...
export type retiredBy<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = retiredBy.$SelectionSet<_$Context>

export namespace retiredBy {
export interface $SelectionSet<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.Base, $Named.User<_$Context> {
}

/**
* This is the "expanded" version of the `retiredBy` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<$SelectionSet<_$Context>>
...
export type parent<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = parent.$SelectionSet<_$Context>
...
/**
* This is the "expanded" version of the `parent` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<$SelectionSet<_$Context>>
...
export type inheritedFrom<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = inheritedFrom.$SelectionSet<_$Context>
...
/**
* This is the "expanded" version of the `inheritedFrom` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<$SelectionSet<_$Context>>
...
* | **Parent** | {@link $NamedTypes.$IssueLabel}.issues |
* | **Path** | `IssueLabel.issues(filter)` |
...
* | **Parent** | {@link $NamedTypes.$IssueLabel}.issues |
* | **Path** | `IssueLabel.issues(includeArchived)` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$IssueLabel}.issues |
* | **Path** | `IssueLabel.issues(orderBy)` |
* | **Nullability** | Optional |
*/
...
export type children<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = children.$SelectionSet<_$Context>
...
/**
* Arguments for `children` field. No arguments are required so you may omit this.
*/
readonly $?: $Arguments<_$Context>
}
...
* | **Parent** | {@link $NamedTypes.$IssueLabel}.children |
* | **Path** | `IssueLabel.children(filter)` |
* | **Nullability** | Optional |
*/
...
* | **GraphQL Type** | `String` |
* | **Parent** | {@link $NamedTypes.$IssueLabel}.children |
* | **Path** | `IssueLabel.children(before)` |
* | **Nullability** | Optional |
*/
readonly before?: $Scalars.String<_$Context>
/**
...
* | **GraphQL Type** | `String` |
* | **Parent** | {@link $NamedTypes.$IssueLabel}.children |
* | **Path** | `IssueLabel.children(after)` |
* | **Nullability** | Optional |
*/
readonly after?: $Scalars.String<_$Context>
/**
...
* | **GraphQL Type** | `Int` |
* | **Parent** | {@link $NamedTypes.$IssueLabel}.children |
* | **Path** | `IssueLabel.children(first)` |
* | **Nullability** | Optional |
*/
readonly first?: $Scalars.Int<_$Context>
/**
...
* | **GraphQL Type** | `Boolean` |
* | **Parent** | {@link $NamedTypes.$IssueLabel}.children |
* | **Path** | `IssueLabel.children(includeArchived)` |
* | **Nullability** | Optional |
*/
readonly includeArchived?: $Scalars.Boolean<_$Context>
/**
...
* | **GraphQL Type** | `PaginationOrderBy` |
* | **Parent** | {@link $NamedTypes.$IssueLabel}.children |
* | **Path** | `IssueLabel.children(orderBy)` |
* | **Nullability** | Optional |
*/
readonly $orderBy?: GraphqlKit.Document.Object.Var.MaybeSchemaful<$Named.PaginationOrderBy | null | undefined>
}
