...
export type * as IssueLabelPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IssueLabelPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueLabelPayload} |
* | **Path** | `IssueLabelPayload.lastSyncId` |
...
* | **Parent** | {@link $NamedTypes.$IssueLabelPayload} |
* | **Path** | `IssueLabelPayload.issueLabel` |
* | **Nullability** | Required |
*/
issueLabel?: $Fields.issueLabel.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.issueLabel<_$Context>>
/**
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$IssueLabelPayload} |
* | **Path** | `IssueLabelPayload.success` |
* | **Nullability** | Required |
*/
