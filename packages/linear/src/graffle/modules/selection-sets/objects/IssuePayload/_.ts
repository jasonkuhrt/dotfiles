...
export type * as IssuePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IssuePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssuePayload} |
* | **Path** | `IssuePayload.lastSyncId` |
