...
export type * as IssuePriorityValue from './__.js'
...
* | **Fields** | 2 |
*/
export interface IssuePriorityValue<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssuePriorityValue} |
