...
export type * as IssueRelationHistoryPayload from './__.js'
...
* | **Fields** | 2 |
*/
export interface IssueRelationHistoryPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueRelationHistoryPayload} |
