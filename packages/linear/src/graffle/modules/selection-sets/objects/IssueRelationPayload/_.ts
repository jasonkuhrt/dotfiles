...
export type * as IssueRelationPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IssueRelationPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueRelationPayload} |
...
* | **Nullability** | Required |
*/
issueRelation?: $Fields.issueRelation.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.issueRelation<_$Context>>
/**
