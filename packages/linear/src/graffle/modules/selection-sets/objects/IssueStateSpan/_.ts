...
export type * as IssueStateSpan from './__.js'
...
* | **Fields** | 5 |
*/
export interface IssueStateSpan<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueStateSpan} |
