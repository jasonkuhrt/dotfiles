...
export type * as IssueToReleasePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface IssueToReleasePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$IssueToReleasePayload} |
...
* | **Nullability** | Required |
*/
issueToRelease?: $Fields.issueToRelease.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.issueToRelease<_$Context>>
/**
