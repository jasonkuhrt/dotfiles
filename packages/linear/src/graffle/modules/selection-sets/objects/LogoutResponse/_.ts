...
export type * as LogoutResponse from './__.js'
...
* | **Fields** | 1 |
*/
export interface LogoutResponse<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$LogoutResponse} |
