...
export type * as NotificationArchivePayload from './__.js'
...
*/
export interface NotificationArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$NotificationArchivePayload} |
* | **Path** | `NotificationArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$NotificationArchivePayload} |
* | **Path** | `NotificationArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$NotificationArchivePayload} |
* | **Path** | `NotificationArchivePayload.entity` |
