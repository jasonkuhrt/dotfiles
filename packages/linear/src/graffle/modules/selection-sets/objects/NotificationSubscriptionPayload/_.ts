...
export type * as NotificationSubscriptionPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface NotificationSubscriptionPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$NotificationSubscriptionPayload} |
...
* | **Nullability** | Required |
*/
notificationSubscription?: $Fields.notificationSubscription.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.notificationSubscription<_$Context>>
/**
