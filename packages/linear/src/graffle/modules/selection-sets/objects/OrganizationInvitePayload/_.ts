...
export type * as OrganizationInvitePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface OrganizationInvitePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$OrganizationInvitePayload} |
...
* | **Nullability** | Required |
*/
organizationInvite?: $Fields.organizationInvite.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.organizationInvite<_$Context>>
/**
