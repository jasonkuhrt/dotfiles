...
export type * as OrganizationMeta from './__.js'
...
* | **Fields** | 2 |
*/
export interface OrganizationMeta<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$OrganizationMeta} |
