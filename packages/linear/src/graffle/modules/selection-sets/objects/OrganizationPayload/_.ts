...
export type * as OrganizationPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface OrganizationPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$OrganizationPayload} |
* | **Path** | `OrganizationPayload.lastSyncId` |
...
* | **Parent** | {@link $NamedTypes.$OrganizationPayload} |
* | **Path** | `OrganizationPayload.organization` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$OrganizationPayload} |
* | **Path** | `OrganizationPayload.success` |
* | **Nullability** | Required |
*/
