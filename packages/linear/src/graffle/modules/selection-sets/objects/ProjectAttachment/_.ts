...
export type * as ProjectAttachment from './__.js'
...
*/
export interface ProjectAttachment<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.id` |
...
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.createdAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.updatedAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.archivedAt` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.subtitle` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.creator` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.metadata` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectAttachment} |
* | **Path** | `ProjectAttachment.sourceType` |
* | **Nullability** | Optional |
*/
sourceType?: $Fields.sourceType.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.sourceType<_$Context>> | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
