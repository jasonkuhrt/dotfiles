...
export type * as ProjectMilestone from './__.js'
...
*/
export interface ProjectMilestone<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectMilestone} |
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$ProjectMilestoneStatus}! |
