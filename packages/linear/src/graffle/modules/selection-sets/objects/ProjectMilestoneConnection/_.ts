...
export type * as ProjectMilestoneConnection from './__.js'
...
* | **Fields** | 3 |
*/
export interface ProjectMilestoneConnection<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$ProjectMilestoneEdge}[]! |
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectMilestoneConnection} |
