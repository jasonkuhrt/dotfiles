...
export type * as ProjectMilestoneMoveIssueToTeam from './__.js'
...
* | **Fields** | 2 |
*/
export interface ProjectMilestoneMoveIssueToTeam<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectMilestoneMoveIssueToTeam} |
