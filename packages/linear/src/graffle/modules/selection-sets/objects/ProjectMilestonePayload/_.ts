...
export type * as ProjectMilestonePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ProjectMilestonePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectMilestonePayload} |
