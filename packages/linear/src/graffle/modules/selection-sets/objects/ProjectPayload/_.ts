...
export type * as ProjectPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ProjectPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectPayload} |
* | **Path** | `ProjectPayload.lastSyncId` |
