...
export type * as ProjectRelationPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ProjectRelationPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectRelationPayload} |
...
* | **Nullability** | Required |
*/
projectRelation?: $Fields.projectRelation.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.projectRelation<_$Context>>
/**
