...
export type * as ProjectStatusArchivePayload from './__.js'
...
*/
export interface ProjectStatusArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectStatusArchivePayload} |
* | **Path** | `ProjectStatusArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectStatusArchivePayload} |
* | **Path** | `ProjectStatusArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$ProjectStatusArchivePayload} |
* | **Path** | `ProjectStatusArchivePayload.entity` |
