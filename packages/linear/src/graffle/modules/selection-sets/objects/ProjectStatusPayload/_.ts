...
export type * as ProjectStatusPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ProjectStatusPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectStatusPayload} |
* | **Path** | `ProjectStatusPayload.lastSyncId` |
...
* | **Parent** | {@link $NamedTypes.$ProjectStatusPayload} |
* | **Path** | `ProjectStatusPayload.status` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectStatusPayload} |
* | **Path** | `ProjectStatusPayload.success` |
* | **Nullability** | Required |
*/
