...
export type * as ProjectUpdateArchivePayload from './__.js'
...
*/
export interface ProjectUpdateArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectUpdateArchivePayload} |
* | **Path** | `ProjectUpdateArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectUpdateArchivePayload} |
* | **Path** | `ProjectUpdateArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$ProjectUpdateArchivePayload} |
* | **Path** | `ProjectUpdateArchivePayload.entity` |
