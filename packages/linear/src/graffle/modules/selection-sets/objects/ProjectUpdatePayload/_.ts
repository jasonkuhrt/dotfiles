...
export type * as ProjectUpdatePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ProjectUpdatePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectUpdatePayload} |
