...
export type * as ProjectUpdateReminderPayload from './__.js'
...
* | **Fields** | 2 |
*/
export interface ProjectUpdateReminderPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ProjectUpdateReminderPayload} |
* | **Path** | `ProjectUpdateReminderPayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ProjectUpdateReminderPayload} |
* | **Path** | `ProjectUpdateReminderPayload.success` |
* | **Nullability** | Required |
*/
