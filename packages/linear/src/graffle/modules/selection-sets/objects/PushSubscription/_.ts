...
export type * as PushSubscription from './__.js'
...
*/
export interface PushSubscription<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$PushSubscription} |
* | **Path** | `PushSubscription.id` |
...
* | **Parent** | {@link $NamedTypes.$PushSubscription} |
* | **Path** | `PushSubscription.createdAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$PushSubscription} |
* | **Path** | `PushSubscription.updatedAt` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlscalartype | ScalarCustom ↗} |
* | **Parent** | {@link $NamedTypes.$PushSubscription} |
* | **Path** | `PushSubscription.archivedAt` |
