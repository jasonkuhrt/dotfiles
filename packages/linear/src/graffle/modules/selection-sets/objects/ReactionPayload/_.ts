...
export type * as ReactionPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ReactionPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReactionPayload} |
...
* | **Nullability** | Required |
*/
reaction?: $Fields.reaction.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.reaction<_$Context>>
/**
* # Info
*
* | | |
