...
export type * as ReleaseArchivePayload from './__.js'
...
*/
export interface ReleaseArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReleaseArchivePayload} |
* | **Path** | `ReleaseArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ReleaseArchivePayload} |
* | **Path** | `ReleaseArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$ReleaseArchivePayload} |
* | **Path** | `ReleaseArchivePayload.entity` |
