...
export type * as ReleasePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ReleasePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReleasePayload} |
