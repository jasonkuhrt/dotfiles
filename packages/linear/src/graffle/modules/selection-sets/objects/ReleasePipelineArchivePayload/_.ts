...
export type * as ReleasePipelineArchivePayload from './__.js'
...
*/
export interface ReleasePipelineArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReleasePipelineArchivePayload} |
