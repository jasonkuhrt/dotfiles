...
export type * as ReleasePipelinePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ReleasePipelinePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReleasePipelinePayload} |
