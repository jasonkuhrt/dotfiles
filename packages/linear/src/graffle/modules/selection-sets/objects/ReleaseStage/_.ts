...
export type * as ReleaseStage from './__.js'
...
*/
export interface ReleaseStage<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReleaseStage} |
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$ReleaseStageType}! |
