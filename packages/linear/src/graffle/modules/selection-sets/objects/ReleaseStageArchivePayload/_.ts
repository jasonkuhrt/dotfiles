...
export type * as ReleaseStageArchivePayload from './__.js'
...
*/
export interface ReleaseStageArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReleaseStageArchivePayload} |
* | **Path** | `ReleaseStageArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ReleaseStageArchivePayload} |
* | **Path** | `ReleaseStageArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$ReleaseStageArchivePayload} |
* | **Path** | `ReleaseStageArchivePayload.entity` |
