...
export type * as ReleaseStagePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ReleaseStagePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ReleaseStagePayload} |
...
* | **Nullability** | Required |
*/
releaseStage?: $Fields.releaseStage.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.releaseStage<_$Context>>
/**
