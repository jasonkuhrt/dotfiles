...
export type * as RoadmapArchivePayload from './__.js'
...
*/
export interface RoadmapArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$RoadmapArchivePayload} |
