...
export type * as RoadmapPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface RoadmapPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$RoadmapPayload} |
...
* | **Nullability** | Required |
*/
roadmap?: $Fields.roadmap.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.roadmap<_$Context>>
/**
