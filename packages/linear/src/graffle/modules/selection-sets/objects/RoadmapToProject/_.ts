...
export type * as RoadmapToProject from './__.js'
...
*/
export interface RoadmapToProject<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$RoadmapToProject} |
