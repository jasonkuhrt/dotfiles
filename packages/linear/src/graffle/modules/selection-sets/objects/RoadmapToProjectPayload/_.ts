...
export type * as RoadmapToProjectPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface RoadmapToProjectPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$RoadmapToProjectPayload} |
...
* | **Nullability** | Required |
*/
roadmapToProject?: $Fields.roadmapToProject.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.roadmapToProject<_$Context>>
/**
