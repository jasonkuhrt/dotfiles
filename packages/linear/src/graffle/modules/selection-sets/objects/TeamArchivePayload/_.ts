...
export type * as TeamArchivePayload from './__.js'
...
*/
export interface TeamArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$TeamArchivePayload} |
* | **Path** | `TeamArchivePayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$TeamArchivePayload} |
* | **Path** | `TeamArchivePayload.success` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$TeamArchivePayload} |
* | **Path** | `TeamArchivePayload.entity` |
