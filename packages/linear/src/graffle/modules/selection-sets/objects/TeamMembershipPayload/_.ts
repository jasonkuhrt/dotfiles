...
export type * as TeamMembershipPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface TeamMembershipPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$TeamMembershipPayload} |
...
*/
teamMembership?: $Fields.teamMembership.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.teamMembership<_$Context>>
/**
