...
export type * as TemplatePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface TemplatePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$TemplatePayload} |
