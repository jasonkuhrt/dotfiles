...
export type * as TimeSchedulePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface TimeSchedulePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$TimeSchedulePayload} |
...
* | **Nullability** | Required |
*/
timeSchedule?: $Fields.timeSchedule.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.timeSchedule<_$Context>>
/**
