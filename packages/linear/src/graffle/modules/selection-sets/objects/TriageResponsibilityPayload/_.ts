...
export type * as TriageResponsibilityPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface TriageResponsibilityPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$TriageResponsibilityPayload} |
