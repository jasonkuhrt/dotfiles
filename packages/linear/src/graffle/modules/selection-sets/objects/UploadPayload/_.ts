...
export type * as UploadPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface UploadPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UploadPayload} |
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$UploadFile} |
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$UploadPayload} |
* | **Path** | `UploadPayload.uploadFile` |
* | **Nullability** | Optional |
*/
uploadFile?: $Fields.uploadFile.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.uploadFile<_$Context>>
/**
