...
export type * as UserAdminPayload from './__.js'
...
* | **Fields** | 1 |
*/
export interface UserAdminPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserAdminPayload} |
