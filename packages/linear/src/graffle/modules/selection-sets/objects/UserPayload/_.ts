...
export type * as UserPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface UserPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserPayload} |
