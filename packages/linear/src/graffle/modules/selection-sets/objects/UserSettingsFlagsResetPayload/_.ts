...
export type * as UserSettingsFlagsResetPayload from './__.js'
...
* | **Fields** | 2 |
*/
export interface UserSettingsFlagsResetPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserSettingsFlagsResetPayload} |
* | **Path** | `UserSettingsFlagsResetPayload.lastSyncId` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserSettingsFlagsResetPayload} |
* | **Path** | `UserSettingsFlagsResetPayload.success` |
* | **Nullability** | Required |
*/
