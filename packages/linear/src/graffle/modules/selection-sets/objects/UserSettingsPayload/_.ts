...
export type * as UserSettingsPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface UserSettingsPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserSettingsPayload} |
