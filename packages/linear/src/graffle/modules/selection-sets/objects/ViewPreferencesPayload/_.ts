...
export type * as ViewPreferencesPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface ViewPreferencesPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ViewPreferencesPayload} |
...
* | **Nullability** | Required |
*/
viewPreferences?: $Fields.viewPreferences.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.viewPreferences<_$Context>>
/**
