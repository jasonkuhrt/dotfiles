...
export type * as WebhookPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface WebhookPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$WebhookPayload} |
...
* | **Nullability** | Required |
*/
webhook?: $Fields.webhook.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.webhook<_$Context>>
/**
