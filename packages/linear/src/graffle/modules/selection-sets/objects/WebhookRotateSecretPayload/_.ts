...
export type * as WebhookRotateSecretPayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface WebhookRotateSecretPayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$WebhookRotateSecretPayload} |
...
* | **Nullability** | Required |
*/
secret?: $Fields.secret.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.secret<_$Context>> | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
