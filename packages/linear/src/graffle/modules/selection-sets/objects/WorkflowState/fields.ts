...
export type position<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort
| GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
| position.$SelectionSet<_$Context>
...
/**
* This is the "expanded" version of the `position` type. It is identical except for the fact
* that IDEs will display its contents (a union type) directly, rather than the name of this type.
* In some cases, this is a preferable DX, making the types easier to read for users.
*/
export type $Expanded<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = $$Utilities.Simplify<GraphqlKit.Document.Object.Select.Indicator.NoArgsIndicator
...
* | **Parent** | {@link $NamedTypes.$WorkflowState}.issues |
* | **Path** | `WorkflowState.issues(filter)` |
...
* | **GraphQL Type** | `String` |
* | **Parent** | {@link $NamedTypes.$WorkflowState}.issues |
* | **Path** | `WorkflowState.issues(before)` |
* | **Nullability** | Optional |
*/
...
* | **GraphQL Type** | `String` |
* | **Parent** | {@link $NamedTypes.$WorkflowState}.issues |
* | **Path** | `WorkflowState.issues(after)` |
* | **Nullability** | Optional |
*/
...
* | **GraphQL Type** | `Int` |
* | **Parent** | {@link $NamedTypes.$WorkflowState}.issues |
* | **Path** | `WorkflowState.issues(first)` |
* | **Nullability** | Optional |
*/
...
* | **GraphQL Type** | `Int` |
* | **Parent** | {@link $NamedTypes.$WorkflowState}.issues |
* | **Path** | `WorkflowState.issues(last)` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$WorkflowState}.issues |
* | **Path** | `WorkflowState.issues(includeArchived)` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$WorkflowState}.issues |
* | **Path** | `WorkflowState.issues(orderBy)` |
* | **Nullability** | Optional |
*/
