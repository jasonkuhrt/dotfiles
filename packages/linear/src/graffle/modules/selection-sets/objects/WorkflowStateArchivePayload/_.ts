...
export type * as WorkflowStateArchivePayload from './__.js'
...
*/
export interface WorkflowStateArchivePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$WorkflowStateArchivePayload} |
