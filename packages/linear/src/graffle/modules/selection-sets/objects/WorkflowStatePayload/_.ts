...
export type * as WorkflowStatePayload from './__.js'
...
* | **Fields** | 3 |
*/
export interface WorkflowStatePayload<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$WorkflowStatePayload} |
...
* | **Nullability** | Required |
*/
workflowState?: $Fields.workflowState.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.workflowState<_$Context>>
/**
